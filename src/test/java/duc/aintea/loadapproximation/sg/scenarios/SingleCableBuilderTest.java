...
public class SingleCableBuilderTest extends ExtractionTest {
    ...
    protected Substation generateSubs(boolean[] fuseStates, double[] consumptions) {
        return SingleCableBuilder.build(fuseStates, consumptions);
    }
    ...
    public void testExtractionCables(double[] consumptions) {
        var def_fuseStates = new boolean[]{true, true};
