...
/**
 * First attempt of an algorithm to validate a path, i.e., to check if the number of actual cuts equal the number of
 * effective cuts. From the list of open fuses, it computes the number of cut.
 *
 * <strong>WARNING:</strong> this algorithm is not working and/or contains bugs. Moreover, it might be over-complicated.
 */
